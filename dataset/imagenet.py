...
def get_dataloader_sample(opt, batch_size=64, num_workers=16, is_sample=False, k=4096):
...
def get_imagenet_dataloader(opt, batch_size=64, num_workers=16, is_instance=False):
    data_folder = get_data_folder(opt)
