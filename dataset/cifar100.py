...
def get_cifar100_dataloaders(opt, batch_size=64, num_workers=4, is_instance=False):
...
def get_cifar100_dataloaders_sample(opt, batch_size=64, num_workers=4, k=4096, mode='exact',
